...
from contentcuration.viewsets.catalog import CatalogViewSet
...
urlpatterns += [
    ...
    url(r'^api/catalog/details/(?P<channel_id>[^/]{32})$', public_views.get_catalog_details, name="get_catalog_details"),
]
