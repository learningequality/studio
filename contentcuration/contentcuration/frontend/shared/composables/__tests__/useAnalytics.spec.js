  ...
  describe('useAnalytics', () => {
    ...
    describe('reset', () => {
      ...
      it('should execute reset when dataLayer has changed', () => {
        const dlReset = (mockDataLayer.reset = jest.fn());
        ...
        expect(typeof mockDataLayer[mockDataLayer.length - 1]).toBe('function');

        mockDataLayer[mockDataLayer.length - 1]();
        expect(dlReset).toHaveBeenCalled();
      });
  ...
  describe('Analytics', () => {
    ...
    describe('destroyInstance', () => {
      it('should nullify the instance and clear interval', () => {
        const instance = Analytics.getInstance();
        const spy = jest.spyOn(instance, '_destroy');
        Analytics.destroyInstance();
