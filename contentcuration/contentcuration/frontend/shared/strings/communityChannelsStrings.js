...
export const communityChannelsStrings = createTranslator('CommunityChannelsStrings', {
  ...
  modeDraftDescription: {
    message: 'Your channel will be saved as a draft, allowing you to review or conduct quality checks without altering the published version on Kolibri public library.',
  },
  publishingInfo: {
  ...
  incompleteResourcesDescription: {
    message: 'Incomplete resources will not be published and made available for download in Kolibri. Click \'Publish\' to confirm that you would like to publish anyway.',
  },
  maxLengthError: {
