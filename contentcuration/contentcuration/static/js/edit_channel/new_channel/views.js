...
var ChannelListPage = BaseViews.BaseView.extend({
  ...
  render: function() {
    ...
    this.pending_channel_list = new PendingChannelList({
      container: this,
      el: this.$('#pending_list'),
    });
    var self = this;
...
var ChannelListPendingItem = BaseViews.BaseListEditableItemView.extend({
  ...
  decline: function() {
    var self = this;
    dialog.dialog(
      self.get_translation('declining_invitation'),
      self.get_translation('declining_invitation_message'),
      {
...
var ChannelSetListItem = BaseViews.BaseListEditableItemView.extend({
  ...
  delete_channel_set: function(event) {
    ...
    var self = this;
    dialog.dialog(
      self.get_translation('delete_channel_set'),
      self.get_translation('delete_channel_set_text'),
      {
        [self.get_translation('cancel')]: function() {},
