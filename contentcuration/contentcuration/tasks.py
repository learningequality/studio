...
def export_channel_task(self, user_id, channel_id, description=''):
    publish_channel(user_id, channel_id, description=description, send_email=True, task_object=self)
