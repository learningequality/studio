...
def custom_show_toolbar(request):
    return not any(request.path.startswith(url) for url in EXCLUDED_DEBUG_URLS)  # noqa F405
...
try:
    ...
    MIDDLEWARE_CLASSES += ('contentcuration.debug.middleware.CustomDebugPanelMiddleware',)  # noqa F405
