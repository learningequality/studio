...
from contentcuration.models import Channel, CommunityLibrarySubmission
...
class ChannelMutualExclusivityTestCase(StudioTestCase):
    ...
    def test_public_channel_cannot_be_submitted_to_community_library(self):
        ...
        self.assertIn("Cannot create a community library submission for a public channel", str(context.exception))
    ...
    def test_community_channel_cannot_be_marked_public(self):
        ...
        self.assertIn("This channel has been added to the Community Library and cannot be marked public", str(context.exception))
...
class AdminChannelSerializerMutualExclusivityTestCase(StudioTestCase):
    ...
    def test_serializer_validates_community_channel_cannot_be_public(self):
        ...
        self.assertIn("This channel has been added to the Community Library and cannot be marked public", str(serializer.errors))
...
class CommunityLibrarySubmissionMutualExclusivityAPITestCase(StudioAPITestCase):
    ...
    def test_api_prevents_public_channel_submission_to_community_library(self):
        ...
        self.assertIn("Cannot create a community library submission for a public channel", str(response.data))
    ...
    def test_api_prevents_approving_submission_for_public_channel(self):
        ...
        url = reverse("admin-community-library-submission-resolve", kwargs={"pk": submission.id})
        data = {
            "status": constants.STATUS_APPROVED,
        }
        ...
        response = self.client.post(url, data, format="json")
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertIn("Cannot approve a community library submission for a channel that has been marked public", str(response.data))
