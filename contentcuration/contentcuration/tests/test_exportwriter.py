...
class ChannelDetailsTestCase(BaseAPITestCase):
    ...
    def test_pluralization(self):
        ...
        self.assertEqual(writer.pluralize_constant(0, "resource"), "0 Resources")
        self.assertEqual(writer.pluralize_constant(1, "resource"), "1 Resource")
        self.assertEqual(writer.pluralize_constant(2, "resource"), "2 Resources")
