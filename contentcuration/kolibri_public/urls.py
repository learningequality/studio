...
urlpatterns = [
    ...
    re_path(r'^api/public/(?P<version>[^/]+)/channels$', views_v1.get_public_channel_list, name='get_public_channel_list'),
    re_path(r'^api/public/(?P<version>[^/]+)/channels/lookup/(?P<identifier>[^/]+)', views_v1.get_public_channel_lookup, name='get_public_channel_lookup'),
