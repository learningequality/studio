Feature: Manage collections
	...
	Scenario: Create a collection by selecting channels
		...
		Then I see the *Select channels* page
			And I am on the *Kolibri library* tab # alternatively I can select *My channels* or the *View-only* tab
	...
	Scenario: Learn about collections
		When I click the *Learn more about collections* link
		...
		Then the modal closes
			And I am back at the *Collections* page
