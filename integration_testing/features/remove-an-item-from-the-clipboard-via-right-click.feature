Feature: Remove an item from the clipboard via right click
	...
	Scenario: Remove an item from the clipboard via right click
		...
		Then the dropdown menu disappears
			And I see that the item in question is removed from the clipboard